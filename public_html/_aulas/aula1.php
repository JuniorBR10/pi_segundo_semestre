...
<section id="corpo_principal">
        ...
        <table id="material">
            <tr>
                <td>
                    <a target="_blank" href="https://drive.google.com/drive/folders/0B9zm4jCrzBohWGM0b25kN1hCZnc?usp=sharing">
                        <img src="_projeto_galeria/pdf-icon.png">
                    </a>
                </td>
                <td>
                    <a target="_blank" href="https://drive.google.com/drive/folders/0B9zm4jCrzBohMlhoNDNaZGRNN0E?usp=sharing">
                        <img src="_projeto_galeria/mp3-icon.png">
                    </a>
                </td>
            </tr>
        </table>
        ...
        <div id="msg">
            <span id="msg">
                Faça <a href="index.php?p=login&pagina_anterior=<?=$pagina_atual?>">login</a> para ter acesso ao material didático!
            </span><br><br>
            <span id="msg2">
