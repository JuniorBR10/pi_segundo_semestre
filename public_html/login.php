...
<div id="divisao_corpo_cabecalho"></div>
    ...
    <section id="corpo_principal">
        ...
        <form action="logar.php?pagina_anterior=<?=$pagina_anterior?>" method="post">
            <label>
                Usuário <br><span class="span_erro"><?=@$erro_login?></span>
                <input class="<?=@$class_login?>" type="text" name="nome_user" placeholder="Nome de Usuário" required value="<?=@$login?>">
            </label><br>
            
            <label>
                Senha<br><span class="span_erro"><?=@$erro_senha?></span>
                <input class="<?=@$class_senha?>" type="password" name="senha_user" placeholder="**********" required>
            </label><br>
